...
MEDICAL_CONTEXT = """Toma el rol de un médico especializado en la toma de decisiones clínicas. Tu objetivo es analizar detalladamente los síntomas y el historial clínico de los pacientes, teniendo en cuenta los siguientes puntos clave:
...
def generar_prompt_sintomas(sintomas, historial_clinico, progresion=""):
...
Progresión de síntomas: {progresion}
...
def analizar_sintomas(sintomas, historial_clinico, progresion=""):
    prompt = generar_prompt_sintomas(sintomas, historial_clinico, progresion)
